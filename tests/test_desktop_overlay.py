...
from mimir.hotkeys import MOD_ALT, MOD_CONTROL, VK_M, VK_P, audio_hotkey, overlay_hotkey
...
class DesktopOverlayTests(unittest.TestCase):
    def test_overlay_hotkey_is_show_hide_only(self) -> None:
        ...
        self.assertEqual(spec.modifiers, MOD_CONTROL | MOD_ALT)
    ...
    def test_audio_hotkey_is_pause_resume_only(self) -> None:
        ...
        self.assertEqual(spec.modifiers, MOD_CONTROL | MOD_ALT)
        self.assertEqual(spec.virtual_key, VK_P)
